...
//Définition de la classe LIVEUSER2LOGIN

class LIVEUSER2LOGIN extends MAIN_CLASS {

// ---------- Type d'encodage de la page------
var $encoding	= "UTF-8";
// ---------- buffer a afficher avant le formulaire Quickform------
var $headerBuffer	= array("<br/> container : Auth_XML + Perm_XML.",
...
"<br/> Ici le test prend en charge l'autentification <b>et</b> la permission. ",
"<br/> L'exemple est assez d&eacute;monstratif. ",
"<p>&nbsp;</p>",
...
// ---------- méthodes de l'objet ------
// constructeur LIVEUSER2LOGIN
function LIVEUSER2LOGIN ( $vars )
{
...
$handleName = "liveuser2login".$this->displayHandle."Display";
return $this->$handleName( $action, $part );

}

//------------------ liveuser2loginDefaultDisplay ---------------------
...
/***********************************************************************************
function liveuser2loginDefaultDisplay( $action, $part )
{
...
$page->setTitle('Phpaie (LIVEUSER2LOGIN)');
$vars = $this->vars;
$titles = $this->titles;
...
$page->addBodyContent("<h3><span class=\"f_header\">Identification LiveUser (2)&nbsp;</span></h3>\n");
$page->addBodyContent("<br/> container : Auth_XML + Perm_XML.\n");
$page->addBodyContent("<br/> Remarque : Le container XML test&eacute; est impl&eacute;ment&eacute; indépendamment\n");
$page->addBodyContent("de la base de donn&eacute;e Phpaie\n");
$page->addBodyContent("<br/> De fait les mots de passe que vous avez peut &ecirc;tre enregistrés dans la base de test sont\n");
$page->addBodyContent("<br/> inop&eacute;rants. \n");
$page->addBodyContent("<br/> Ici le test prend en charge l'autentification <b>et</b> la permission. \n");
$page->addBodyContent("<br/> L'exemple est assez d&eacute;monstratif. \n");
...
$page->addBodyContent("<!-- footer2 footer.php~\"{names}\", \"{params}\", \"{names2}\", \"{params2}\"~\"ATAB_NOMTBL_CKEY_VCH\",$this->getName(), \"PNAME\", \"LIVEUSER2LOGIN\"-->\n");
$page->display();
return 0;
}
***********************************************************************************/

//------------------ liveuser2loginQuickFormDisplay ---------------------
// Fonction d'affichage de la page utilisant le package QuickForm de Pear
// $action : action à déclencher (fonction)
// $part : which part of the page (0 : all)
function liveuser2loginQuickFormDisplay( $action, $part )
{
//			foreach ( $vars as $key=>$value )
//			{
//			print "<li>\$key $key => \$value $value</li>\n";
...
require_once ("LIVEUSER2LOGIN_InitForm.php");
$page = new HTML_Page(array ('lineend'   => 'unix', 'doctype'   => 'XHTML 1.0 Strict', 'language'  => 'fr',   'cache'	=> 'false'   ));
...
$form = new HTML_QuickForm('LIVEUSER2LOGIN', 'post' , (isset($this->anchor)  && !empty ($this->anchor)) ? "#".$this->anchor : "");
$form->_requiredNote = '<span style="font-size:80%; color:#ff0000;">*</span><span style="font-size:80%;">: champs obligatoires.</span>';
//--------------------------LIVEUSER2LOGIN_handle--------------------------
//Static LIVEUSER2LOGIN_handle
...
//--------------------------LIVEUSER2LOGIN_passwd--------------------------
//Static LIVEUSER2LOGIN_passwd
...
************************* END TO substitute **************/
$page->addBodyContent( str_replace(array("{names}", "{params}", "{names2}", "{params2}"), array("ATAB_NOMTBL_CKEY_VCH",$this->getName(), "PNAME", "LIVEUSER2LOGIN"), file("../common/footer.php"))); //QCKFSET.pl 200 
//fin du formulaire
...
{
$status = 0;
if (file_exists("Business_liveuser2login.php")){
	require_once ("Business_liveuser2login.php");
	}
return $status;
}
...
{
MAIN_CLASS::insertDbVars("INSCRIPTION", $pvars, LIVEUSER2LOGIN::getInitInputs());
}
