 ...
 * @access public
 */
class Phpaie_Renderer_Default extends HTML_QuickForm_Renderer
{
    var $_mytag = "c'est mon renderer à moi <BR/>";
   /**
...
//        "\n\t<tr>\n\t\t<td align=\"right\" valign=\"center\"><!-- BEGIN required --><span style=\"color: #ff0000\">*</span><!-- END required --><b>{label}</b></td>\n\t\t<td valign=\"top\" align=\"left\"><!-- BEGIN error --><span style=\"color: #ff0000\">{error}</span><br /><!-- END error -->\t{element}</td>\n\t</tr>";
//        "\n\t<tr>\n\t\t<td width=\"50%\" align=\"right\" valign=\"center\"><!-- BEGIN required --><span style=\"color: #ff0000\">*</span><!-- END required -->{label}</td>\n\t\t<td valign=\"center\" align=\"left\"><!-- BEGIN error --><span style=\"color: #ff0000\">{error}</span><br /><!-- END error -->\t{element}</td>\n\t</tr>";
        "\n\t<tr>\n\t\t<td align=\"right\" valign=\"center\"><!-- BEGIN required --><span style=\"color: #ff0000\">*</span><!-- END required -->{label}</td>\n\t\t<td valign=\"center\" align=\"left\"><!-- BEGIN error --><span style=\"color: #ff0000\">{error}</span><br /><!-- END error -->\t{element}</td>\n\t</tr>";
    ...
    */
    var $_formTemplate = 
        "\n<div id=\"container\"><form{attributes}>\n<table width=\"100%\" border=\"0\">\n{content}\n</table></div>\n</form>";

   /**
    * Test link template string
    * @var      string
    * @access   private
    */
    var $_linkTemplate = 
    ...
    * @access   private
    */
    var $_groupElementTemplate = 'Tirelipinpon{element}sur le chiuaua';
    ...
    * @access public
    */
    function Phpaie_Renderer_Default()
    {
    ...
    */
    function toHtml()
    {
/*echo " <H3>[".__FILE__."][".__LINE__."]</H3><font color=\"magenta\">renderHtml toHtml (3)</font><BR>\n";
print_r ();*/
        return $this->_html;
    } // end func toHtml
    ...
    */
    ...
    {
        if (!$this->_inGroup) {
/*echo "[".__FILE__."][".__LINE__."]</H3><font color=\"#901090\">\n";
print $element->getName()." <BR>";
echo "</font><BR>\n";*/
...
/*echo "[".__FILE__."][".__LINE__."]</H3><font color=\"#FF1090\"> ".$this->_groupElementTemplate."<BR>\n";
print $element->getName()." <BR>";
echo "</font><BR>\n";*/
...
/*echo "<H3>[".__FILE__."][".__LINE__."]</H3><font color=\"#BABEFA\">renderElementC</font><BR>\n";*/
                $html = preg_replace("/([ \t\n\r]*)?<!-- BEGIN required -->(\s|\S)*<!-- END required -->([ \t\n\r]*)?/i", '', $html);
            }
            $this->_groupElements[] = str_replace('{element}', $element->toHtml(), $html);

        } else {
/*echo "[".__FILE__."][".__LINE__."]</H3><font color=\"blue\">\n";
print_r ($element);
echo "</font><BR>\n";*/
            $this->_groupElements[] = $element->toHtml();
        }
/*echo "<H3>[".__FILE__."][".__LINE__."]</H3><font color=\"#BABEFA\">renderElement End</font><BR>\n";*/
    ...
    */
    ...
    {
/*echo " <H3>[".__FILE__."][".__LINE__."]</H3><font color=\"red\">renderHtml(3)</font><BR>\n";
print_r ($data);*/
